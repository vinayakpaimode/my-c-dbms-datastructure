; ModuleID = '/storage/emulated/0/my c programming/sorting/insertionsort.c.bc'
source_filename = "/storage/emulated/0/my c programming/sorting/insertionsort.c"
...
; <label>:9:                                      ; preds = %5, %15
  ...
  %14 = icmp sgt i32 %13, %8                      ; [#uses=1 type=i1]
...
; <label>:28:                                     ; preds = %34, %24
  ...
  %33 = icmp sgt i32 %32, %27                     ; [#uses=1 type=i1]
